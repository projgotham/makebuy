...
<section class="section-fl-profile js--section-fl-profile">
    ...
    <div class="fl-intro" id="fl-profile">
        ...
        <div class="board_button">
            <a href="#" id="editProfile-button" class="b-button color"><span><i class="ion-edit"></i>프로필 수정</span></a>
            <a href="./sub.php?page=user-profile" id="editProfile-button" class="b-button color"><span><i class="ion-person"></i>개인정보 수정</span></a>
    </div>
