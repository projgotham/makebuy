...
<div class="col-md-6 col-md-offset-3">
    ...
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
        <div class="accordian-title-content">
                ...
                <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                    <div class="panel-body">
                        <p class="answer">
                            ...
                            3.	‘클라이언트 대시보드’에서 현재 등록된 프로젝트와 지원자를 확인하실 수 있습니다. 지원받은 프리랜서 중에서 미팅을 신청하시면 일정조율 후 미팅이 진행됩니다.<br><br>
                            4.	미팅 후 프로젝트에 대해서 최종적으로 합의된 내용으로 계약서 작성이 이뤄집니다. 계약서에 날인이 되고, 프로젝트 대금이 입금되면 프로젝트가 시작됩니다.<br><br><br><br>
            ...
            <div class="panel panel-default" id="box">
                <div class="tap">
                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" id="tap">
    ...
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
        <div class="accordian-title-content">
            ...
            <div class="panel panel-default" id="box">
                <div class="tap">
                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="false" aria-controls="collapseFive" id="tap">
                ...
                <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                    <div class="panel-body">
                        <p class="answer">
                            프로젝트 내용 작성에 어려움을 겪는다면 기획도우미 서비스를 통해 도움을 받으실 수 있습니다. 혹은 고객센터로 연락을 주시면 상담을 통해 프로젝트 내용을 구체화시킬 수 있습니다.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-default" id="box">
                ...
                <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSeven">
                    <div class="panel-body">
                        <p class="answer">
                            -	공개가 어려운 부분을 제외한 내용으로 프로젝트 모집 후에 미팅 시 자세한 내용을 말하는 방법으로 프로젝트 진행이 가능합니다. 또한 미팅 시 NDA(비밀계약유지서) 작성을 원하실 경우 지원해드립니다.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-default" id="box">
                ...
                <div id="collapseNine" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingNine">
                    <div class="panel-body">
                        <p class="answer">
                            일차적으로 클라이언트와 프리랜서 간 협의에 따라 분쟁이 조정됩니다. 둘 사이에서 합의점을 찾지 못할 경우, 이용약관에 명시된 메이크바이의 분쟁 해결절차를 따르게 됩니다.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-default" id="box">
                ...
                <div id="collapseEleven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingEleven">
                    <div class="panel-body">
                        <p class="answer">
                            프로젝트 완료 후에는 취소나 환불이 안됩니다. 프로젝트 진행 중에 취소를 원하시면 계약서에 협의된 내용에 따라 작업 범위나 기간에 따라 대금을 환불 받게 됩니다.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
        <div class="accordian-title-content">
            ...
            <div class="panel panel-default" id="box">
                <div class="tap">
                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThirdteen" aria-expanded="true" aria-controls="collapseThirdTeen">
                ...
                <div id="collapseThirdteen" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThirdteen">
                    <div class="panel-body">
                        <p class="answer">
            ...
            <div class="panel panel-default" id="box">
                <div class="tap">
                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFourteen" aria-expanded="false" aria-controls="collapseFourteen" id="tap">
