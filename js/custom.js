		...
		$(window)	
			.on('scroll', function() {			
				...
				if ($(this).scrollTop() > 46){
					...
					$('body.mean-container .top_menu').addClass('fixed');
					$('body.mean-container .top_gnb .logo').addClass('fixed');
					...
					$('body.mean-container .top_menu').removeClass('fixed');
					$('body.mean-container .top_gnb .logo').removeClass('fixed');
